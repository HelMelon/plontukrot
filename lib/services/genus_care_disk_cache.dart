...
/// Persists genus care guides on device for offline use.
class GenusCareDiskCache {
  GenusCareDiskCache._();

  static const _fileName = 'genus_care_guides.json';
  ...
  static Future<Map<String, GenusCareGuide>> readAll() async {
    try {
      ...
      final result = <String, GenusCareGuide>{};
      for (final entry in entries.entries) {
        ...
        final guide = GenusCareGuide.fromMap(guideMap);
        if (guide.isNotEmpty) {
  ...
  static Future<void> put(String cacheKey, GenusCareGuide guide) async {
  ...
  static Future<void> _writeAll(
    File file,
    Map<String, GenusCareGuide> entries,
  ) async {
