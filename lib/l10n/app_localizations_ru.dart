...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String a11yAppFooter(String appName, String version, String year) {
    return '$appName, версия $version, $year год';
  }
  ...
  @override
  String get a11yChangeProfilePhoto => 'Сменить фото профиля';
  ...
  @override
  String get profileFeatureFlagsTitle => 'Флаги функций';

  @override
  String get profileTabProfile => 'Профиль';

  @override
  String get profileTabAdmin => 'Админ';

  @override
  String get adminShowUsers => 'Показать пользователей';

  @override
  String get adminShowArchive => 'Показать архив';

  @override
  String adminUsersCount(int count) {
    return 'Пользователей: $count';
  }
  ...
  @override
  String get adminColumnName => 'Имя';

  @override
  String get adminColumnEmail => 'Email';

  @override
  String get adminColumnId => 'ID';

  @override
  String get adminColumnStatus => 'Статус';

  @override
  String get adminColumnDeletedAt => 'Удалён';

  @override
  String get adminColumnActions => 'Действия';

  @override
  String get adminStatusActive => 'Активен';

  @override
  String get adminStatusBanned => 'Заблокирован';

  @override
  String get adminStatusDeleted => 'В архиве';

  @override
  String get adminCopyId => 'Копировать ID';

  @override
  String get adminIdCopied => 'ID скопирован';

  @override
  String get profileFeatureFlagsSubtitle =>
      'Влияет на выбранный аккаунт. Значения хранятся на сервере.';

  @override
  String get featureFlagFriends => 'Друзья';

  @override
  String get featureFlagWishList => 'WishLeafs';

  @override
  String get featureFlagFinances => 'Финансы';

  @override
  String get featureFlagPropagations => 'Размножения';

  @override
  String get featureFlagArchive => 'Архив';

  @override
  String get featureFlagGenusCare => 'Справка по роду';

  @override
  String get featureFlagSoilSensors => 'Датчики влажности';

  @override
  String get featureFlagTelegramAlerts => 'Уведомления Telegram';

  @override
  String get featureFlagBalcony => 'Балкон';

  @override
  String get featureFlagFertilizingReminders => 'Напоминания о подкормке';

  @override
  String get featureFlagBulkActions => 'Массовые действия';

  @override
  String get featureFlagsUserIdLabel => 'ID пользователя';

  @override
  String get featureFlagsUserIdRequired => 'Введите ID пользователя';

  @override
  String get featureFlagsLoadUser => 'Загрузить';

  @override
  String featureFlagsForUser(String userId) {
    return 'Флаги для $userId';
  }

  @override
  String get featureFlagsBanSectionTitle => 'Блокировка';
  ...
  @override
  String get featureFlagsBanTitle => 'Заблокировать пользователя';

  @override
  String get featureFlagsBanReasonLabel => 'Причина блокировки';

  @override
  String get featureFlagsBanConfirm => 'Заблокировать';

  @override
  String get featureFlagsBanReasonUnknown => 'причина не указана';

  @override
  String get featureFlagsCannotBanSelf => 'Нельзя заблокировать этот аккаунт';

  @override
  String get featureFlagsUnbanTitle => 'Разблокировать?';
  ...
  @override
  String get featureFlagsUnbanAction => 'Разблокировать';

  @override
  String get featureFlagsDeleteSectionTitle => 'Удаление';

  @override
  String get featureFlagsDeleteHint =>
      'Пользователь попадёт в архив на 3 месяца. Данные сохраняются; войти нельзя. Затем аккаунт удаляется навсегда.';

  @override
  String get featureFlagsDeleteTitle => 'Удалить пользователя';

  @override
  String get featureFlagsDeleteReasonLabel => 'Причина удаления';

  @override
  String get featureFlagsDeleteConfirm => 'Удалить';

  @override
  String get featureFlagsCannotDeleteSelf => 'Нельзя удалить этот аккаунт';

  @override
  String get featureFlagsRestoreTitle => 'Восстановить?';
  ...
  @override
  String get featureFlagsRestoreAction => 'Восстановить';

  @override
  String authBannedMessage(String reason) {
    return 'Вы были заблокированы администрацией. Причина: $reason';
  }

  @override
  String authDeletedMessage(String reason) {
    return 'Аккаунт удалён администрацией. Причина: $reason';
  }
  ...
  @override
  String get plantHybrid => 'Гибрид';

  @override
  String get plantHybridParent1 => 'Родительский вид 1';

  @override
  String get plantHybridParent2 => 'Родительский вид 2';

  @override
  String get plantHybridParentsRequired => 'Укажите оба родительских вида';
